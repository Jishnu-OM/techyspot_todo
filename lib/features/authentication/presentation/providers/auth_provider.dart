...
import 'package:techyspot_todo/features/authentication/domain/usecase/google_signin_usecase.dart';
...
final authProvider = StateNotifierProvider<AuthNotifier, AuthState>((ref) {
  ...
  final googleSigninUsecase = GoogleSignInUseCase(repository);

  return AuthNotifier(loginUseCase, logoutUseCase, googleSigninUsecase);
});
...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  AuthNotifier(this._loginUseCase, this._logoutUseCase, this._googleSigninUsecase)
